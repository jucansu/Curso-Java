...
<%@page session="true" import=" avante.domain.Course"%>
...
<body>
	...
	&& pageContext.request.getParameter(\"deleteId\") != null}">
		...
		<c:catch var="err">
			...
			<jsp:useBean id="courseBean" class="avante.domain.Course" />
			...
			<c:forEach items="${courses}" var="course">
				<tr>
					...
					<td><form method="post">
							...
							<button type="submit" name="deleteId">Delete</button>
						</form></td>
				</tr>
			</c:forEach>
		</table>
