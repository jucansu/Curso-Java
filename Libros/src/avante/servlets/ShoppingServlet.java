...
public class ShoppingServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if (do_this == null) {
			...
			blist.addElement("harry potter. Scott Preston $60.99");
			blist.addElement("El senor de los anillos. Scott Preston $60.99");
			blist.addElement("harry potter. Scott Preston $60.99");
			session.setAttribute("ebookshop.list", blist);
			ServletContext sc = getServletContext();
			RequestDispatcher rd = sc.getRequestDispatcher("/");
			rd.forward(req, res); // redirige a la raiz de nuestro proyecto
		} else {
			...
			if (do_this.equals("checkout")) {
				...
				rd.forward(req, res); // Envia a checkout jsp
			} // if (..checkout..
