...
public class EmpleadoPublico extends Persona implements AutoCloseable {
	...
	public EmpleadoPublico(String nombre, String apellidos, String dni, int edad, LocalDate anhoInicio,
			int anhoJubilacion, TipoContrato tipoContrato, String organismoPublico, int numeroTrienios) {
		super(nombre, apellidos, dni, edad, anhoInicio, anhoJubilacion, tipoContrato);
	...
	public String imprimeHistorial() {
		...
		EmpleadoPublico e = new EmpleadoPublico("pepe", "sanchez", "30224083J", 25, date, 2050, TipoContrato.TEMPORAL,
				"bnu", 1);
		res = e.getNombre();
		return res;
